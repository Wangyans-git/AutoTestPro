        ...
        while True:
            ...
            if random.randint(0, 1) % 2 == 0:
                ...
                if count1 == 0:
                    ...
                    result = self.log_check(self.dataList, 'other', recv_command[value_index].lower().replace(" ", ""))
                    if result == 1:
                        success += 1
                    elif result == 0:
                        fail += 1
                ...
                count1 += 1
                self.fail = count1 - success - 1
                print('设备[%s]' % self.device + '有效指令压测[%s]次，' % (
                        count1 - 1) + '成功了[%s]次，' % success + '失败了[%s]次，' % self.fail +
                      '无效指令发送了%s次' % count2)
                print('-----------------------------------------------------')
                # self.loger.info(
...
if __name__ == '__main__':
    ...
    #                 ]
    invalue_command = ['55 12 02 00 02 01 66', '55 12 02 00 02 00 63', '55 12 07 00 00 6F', '55 12 02 00 02 04 79', '55 12 12 00 00 02 7B']

    mcu_command = [
        # 查询
        # '55 12 F0 00 01 23 7B',  # 心跳
        # "55 12 F1 00 00 58",  #f0查询
        # '55 12 F7 00 01 01 60',  # 软件版本
        # '55 12 f7 00 01 02 61',  # 硬件版本

        # 设置
        # "55 12 01 00 01 00 69",   "55 12 01 00 01 01 6A"# 开关机   有bug
        ""
        "", "55 12 02 00 02 01 02 6e", "55 12 02 00 02 01 03 6f",  # 风扇
        "55 12 02 00 02 02 00 6D", "55 12 02 00 02 02 01 6E", "55 12 02 00 02 02 02 6F", "55 12 02 00 02 02 03 70",
        "55 12 02 00 02 02 04 71", "55 12 02 00 02 02 05 72",  # 自动
        "55 12 02 00 02 03 00 6E",  # 睡眠
        "55 12 02 00 02 04 00 6f",  # Tubro
        "55 12 07 00 01 00 6F",  "55 12 07 00 01 01 70",  # 勿扰开关
        "55 12 04 00 02 00 01 6E",    # 延迟关闭
        # "55 12 12 00 01 00 7A","55 12 12 00 01 01 7B",  # 夜灯


        # "55 12 11 00 01 50 C9",  # 滤网百分比
        # "55 12 13 00 01 01 7C", #滤网重置
        # "55 12 14 00 01 01 7D" #空气指数

    ]

    recv_command = [
        # 'AA 12 F0 00 01 23 D0 ',
        # "AA 12 F1 00 06 51 64 7B 00 00 04 E7",
        # 'AA 12 F7 00 04 01 01 00 06 BF',
        # 'AA 12 F7 00 04 02 01 03 00 BD',


        # "AA 12 01 00 01 00 BE","AA 12 01 00 01 01 BF",
        "AA 12 02 00 02 01 01 C2", "AA 12 02 00 02 01 02 C3", "AA 12 02 00 02 01 03 C4",
        "AA 12 02 00 02 02 00 C2", "AA 12 02 00 02 02 01 C3", "AA 12 02 00 02 02 02 C4", "AA 12 02 00 02 02 03 C5",
        "AA 12 02 00 02 02 04 C6", "AA 12 02 00 02 02 05 C7",
        "AA 12 02 00 02 03 00 C3",
        "AA 12 02 00 02 04 00 C4",
        "AA 12 07 00 01 00 C4","AA 12 07 00 01 01 C5",
        "AA 12 04 00 02 00 01 C3",
        "AA 12 12 00 01 00 CF","AA 12 12 00 01 01 D0",


        # "AA 12 11 00 01 50 1E",
        # "AA 12 13 00 01 01 D1",
        # "AA 12 14 00 02 00 00 D2"
    ]
