...
class H7148_Wifi:
    def __init__(self, com, com1, dbs, dbs1, timeout,sku,sku_des):
        ...
        path = str(Path(ROOT) / "H7148/logs/H7148wifi配网压测.txt")
        print(path)
        ...
        while True:
            try:
                ...
                if self.device(resourceId="com.govee.home:id/ivDevAdd").exists(timeout=10):
                    ...
                    time.sleep(5)
                    while True:
                        self.device(resourceId="com.govee.home:id/sku_des").click_exists(timeout=10)
                        time.sleep(2)
                    ...
                    while True:
                        ...
                        if self.device(text='设备Wi-Fi指示灯以白色慢闪，请短按设备电源键').exists(timeout=10):
                            break
                        elif self.device(resourceId='com.govee.home:id/done').exists(timeout=10):
                            break
                        else:
