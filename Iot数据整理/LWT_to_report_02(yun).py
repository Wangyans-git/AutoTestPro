...
class ErpHandle:
    ...
    def get_erp_data(self, devices_list):
        ...
        for devices in range(0, len(devices_list)):
            ...
            # self.sheet7.cell(4, 1).value = "uE0"
            # self.sheet7.cell(5, 1).value = "uqerr"
            # self.sheet7.cell(6, 1).value = "umerr"
            ...
            for i in range(0, 1):
                ...
                for data in erp_text['data']['data']['list']:
                    ...
                    try:
                        stw = data['data']['message']['state']['sta']['stw']
                        stw_count += 1
                    ...
                    try:
                        ...
                        self.sheet6.cell(4, self.devices_count + 1).value = oldA_2_count
                        # self.sheet6.cell(oldA_rows + 5, self.devices_count * 2).value = oldA
                    except Exception:
                        pass

                    try:
                        uqerr = data['data']['message']['uqerr']
                        umerr = data['data']['message']['umerr']
                        uE0 = data['data']['message']['uE0']
                        oldA_rows += 1
                        if uqerr == 0:
                            err_count += 1
                        elif umerr == 0:
                        ...
                        # self.sheet7.cell(4, self.devices_count + 1).value = uE0_count
                        # self.sheet7.cell(5, self.devices_count + 1).value = uqerr_count
                        # self.sheet7.cell(6, self.devices_count + 1).value = umerr_count
                        self.sheet7.cell(4, self.devices_count + 1).value = err_count
                        # self.sheet6.cell(oldA_rows + 5, self.devices_count * 2).value = oldA
                    except Exception:
                        pass
            ...
            print("保存完成")
            time.sleep(3)
        return self.device_sku, self.device_aid, self.rssi_avg
...
if __name__ == '__main__':
    ...
    devices_list = ["17:E9:60:74:F4:CB:A9:16", "16:DF:60:74:F4:CC:2A:70", "1E:D0:60:74:F4:95:C3:AE",
                    '23:B3:60:74:F4:FC:3E:EC',
                    ]
