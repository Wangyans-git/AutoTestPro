...
import time
import threading
from H7131.myConfig import setting
import uiautomator2 as u2
from H7131.log.loger2 import Loger
            ...
            if self.check_connect():
                ...
                for i in range(times):
                    try:
                        i = i + 1
                        if i % 5 == 1:
                            # self.device(resourceId="com.govee.home:id/iv_gear_low_bg").click_exists(timeout=3.0)
                            ...
                            # self.device(resourceId="com.govee.home:id/iv_gear_mid_bg").click_exists(timeout=3.0)
                            ...
                            # self.device(resourceId="com.govee.home:id/iv_gear_high_bg").click_exists(timeout=3.0)
