...
class H7151Test:
    def __init__(self):
        ...
        # 脚本日志
        self.get_log = GetLog("C:\wys\AutoTestProjects\H7151_Auto\H7151_log\H7151-1_log.log")
        # 获取手机分辨率
            ...
            if self.check_connect():
                while True:
                    try:
                        ...
                        print(e)
                    print(self.sku, "已经设置了了{}次".format(self.n))
                    if self.n == 10000:
                        print(self.sku, "已经设置了{}次".format(self.n))
                        break
            else:
                while True:
                    self.device(text=self.sku).click_exists(timeout=5.0)
    ...
    def gear(self):
        self.device.click(0.177, 0.909)  # 1档
        self.n += 1
        self.pop()
        self.device.click(0.316, 0.909)  # 2档
        self.n += 1
        self.pop()
        self.device.click(0.481, 0.909)  # 3档
        self.n += 1
        self.pop()
        self.device.click(0.618, 0.909)  # 4档
        self.n += 1
        self.pop()
        self.device.click(0.765, 0.909)  # 5档
        self.n += 1
        self.pop()
        self.device.click(0.177, 0.909)  # 1档
        self.n += 1
