...
if __name__ == '__main__':
    ...
    check_dates = ["开机:55 10 01 00 01 01 68", "关机:55 10 01 00 01 00 67"
                   # , '55 10 02 00 01 01 69', '55 10 02 00 01 02 6A',
                   #            '55 10 02 00 01 03 6B', '55 10 03 00 01 01 6A', '55 10 03 00 01 00 69'
                   ]
    # 如果
    if program.err == 0:
        ...
        send_list = ['uart 0x01 0x00', 'uart 0x01 0x01',  # 开机
                     ...
                     'uart 0x02 0x00', 'uart 0x02 0x01', 'uart 0x02 0x02', 'uart 0x02 0x03', 'uart 0x02 0x04',
                     'uart 0x02 0x05', 'uart 0x02 0xfa', 'uart 0x02 0xfc', 'uart 0x02 0xff',  # 模式档位
                     'uart 0x03 0x00', 'uart 0x03 0x01', 'uart 0x03 0x03', 'uart 0x03 0xfa', 'uart 0x03 0xfc',
                     'uart 0x03 0xff',  # 摇头
                     ...
                     'uart 0x08 0x00', 'uart 0x08 0x01', 'uart 0x08 0x02', 'uart 0x08 0xfa', 'uart 0x08 0xfc',
